...
describe("Test mother object", () => {
  it("should't return a error with a valid product", () => {
  ...
  describe("Product validation rules", () => {
    it("should return an object error when creating a new Product with invalid id", () => {
    ...
    it("should return an object error when creating a new Product with invalid name", () => {
    ...
    it("should return an object error when creating a new Product with invalid price", () => {
    ...
    it("should return an object error when creating a new Product with invalid category", () => {
